export default function PrivacyPolicy() {
  return (
    <main style={{ fontFamily: "monospace", fontSize: "14px" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to dnd-gpt.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to dnd-gpt, accessible from{" "}
            <a
              href="https://dnd-gpt.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://dnd-gpt.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email:{"tomerramk@gmail.com"}</li>
      </ul>
    </main>
  );
}
